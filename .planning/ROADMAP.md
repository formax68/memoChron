...
- [ ] 07-02-PLAN.md — DIR-06: adopt activeDocument for getComputedStyle reads; add window. prefix for timers (5 source files)

**Wave 3** *(blocked on Wave 2 completion)*

- [ ] 07-03-PLAN.md — DIR-07: narrow TAbstractFile via instanceof TFile (4 sites across 3 view files)

**Wave 4** *(blocked on Wave 3 completion)*

- [ ] 07-04-PLAN.md — DIR-08: classify floating + misused promises into D-09 buckets; sync onload() wrapper on Embedded*View
...
- [ ] 07-06-PLAN.md — Record Phase 7 human UAT (6-step walkthrough — popout window, daily-note open paths, settings modal, sidebar parity, embedded views parity, lint clean)
